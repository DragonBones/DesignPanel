package cloud.commands
{
	...
	public class DBNC_LoadAbout extends DBNetworkCommandBase
	{
		private static const APIURL:String = "/api/about.html";
		
		public function DBNC_LoadAbout(data:Object=null, target:IEventDispatcher=null)
		{
			super(data, target);
			
			successEvent = DBCloudEvent.LOAD_ABOUT_SUCCESS;
			failedEvent = DBCloudEvent.LOAD_ABOUT_FAILED;
